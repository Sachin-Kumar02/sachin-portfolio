  ...
  return (
    <>
      ...
      <div className="hidden md:flex flex-col items-center fixed bottom-0 left-10 gap-6 after:content-[''] after:w-px after:h-24 after:bg-slate-500">
        ...
        <a href="https://linkedin.com/in/sachinkumar" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-emerald-400 hover:-translate-y-1 transition-all">
